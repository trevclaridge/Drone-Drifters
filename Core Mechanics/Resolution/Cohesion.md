...
## Sidebar: Cohesion Tokens

A fun way to represent the Cohesion players can give each other is to have each player pick a token that represents their character, and pass that token when awarding Cohesion for cool roleplay. A token can be any small trinket, totem, or tchotchke; it should have some meaning to the character who awards it. When a player does something cool and one or more of the other players awards them a Cohesion, they get to look down and be reminded that their friends think they're cool.
